            ...
            {friend.areWeFriend === "깐부 요청 받음" && (
              <div>
                ...
                <Button
                  variant="outlined"
                  color="error"
                  onClick={() => handleRequest("reject", friend.friendUsername)}
                >
                  거절
                </Button>
              </div>
            ...
            {friend.areWeFriend !== "깐부 요청 받음" && (
              <div>
                ...
                <Button
                  ...
                  color="error"
                  style={{ marginLeft: 10 }}
                  onClick={() => handleRequest("delete", friend.friendUsername)}
                >
                  깐부 삭제
                </Button>
              </div>
  ...
  const updateSetting = (event, friendId, settingName) => {
    ...
    call("/v2/friends/settings", "PATCH", updateContent)
      .then((response) => {
        ...
        point.style.backgroundColor = event.target.value
          ? "#FA5858"
          : "#81BEF7";
      })
      .catch((error) => {
          ...
          <div className="wrap">
            ...
            <div class="input-txt">
              <TextField
                ...
                size="small"
              />
              <Button variant="outlined" onClick={() => findCharacter()}>
                검색
              </Button>
            </div>
            <div className="todo-wrap">
              ...
              >
                <Tabs
                  value={tabValue}
                  onChange={(event, friend) => handleChange(event, friend)}
